...
@section('title', 'Buatan Rumah | Daftar Akun')
            ...
            <div class="column is-7">
                <div class="card">
                    <div class="card-content">
                        <div class="content">
                            <h1 class="header-login">Daftar Akun Aplikasi</h1>
                            <form method="post" action="/register">
                                ...
                                <p class="info-sign">Sudah memiliki akun? <a href="/login">Masuk Aplikasi</a> disini!</p>
