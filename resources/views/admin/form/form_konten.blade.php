                                        ...
                                        <div class="field">
                                            ...
                                            <div class="file has-name is-fullwidth">
                                                <label class="file-label">
                                                    <input class="file-input vendor-file" type="file" name="gambar_hero">
                                                    <span class="file-cta">
                                                    ...
                                                    <span class="file-name">
                                                        <span class="file-name-vendor"></span>
                                                    </span>
                                                </label>
                                            </div>
                                            @error('gambar_hero')
                                ...
                                <div class="content">
                                    <form method="post" action="/admin/buatan-rumah" enctype="multipart/form-data">
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="file has-name is-fullwidth">
                                                <label class="file-label">
                                                    <input class="file-input video-content" type="file" name="video">
                                                    <span class="file-cta">
                                                        <span class="file-icon">
                                                            <i class="fas fa-upload"></i>
                                                        </span>
                                            ...
                                            @enderror
                                            <figure class="image is-16by9">
                                                <iframe class="has-ratio new-media-video" width="640" height="360" src="" frameborder="0" allowfullscreen></iframe>
                                            </figure>
                                        </div>
