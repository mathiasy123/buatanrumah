                    ...
                    <div class="level">
                        <div class="level-left">
                            <div class="level-item">
                                <h1 class="title">Form Tambah Makanan Pemasak</h1>
                            </div>
                        </div>
                    ...
                    <div class="card has-background-light">
                        <div class="card-header">
                            <div class="card-header-title">
                                <p class="is-size-5">Kelola Makanan Pemasak</p> 
                            </div>
                        </div>
                                            ...
                                            <div class="control">
                                                <div class="select @error('pemilik_makanan') is-danger @enderror">
                                                    <select name="pemilik_makanan">
                                                        ...
                                                        <option value="{{ $chef->id }}" {{ (old('pemilik_makanan') == $chef->id) ? 'selected' : '' }}>{{ $chef->name }}</option>
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="file has-name is-fullwidth @error('gambar_makanan') is-danger @enderror">
                                                <label class="file-label">
                                                    <input class="file-input" type="file" name="gambar_makanan">
                                                    <span class="file-cta">
                                            ...
                                            <div class="control">
                                                <div class="select @error('pemilik_makanan') is-danger @enderror">
                                                    <select name="pemilik_makanan">
                                                        ...
                                                        @foreach($chefs as $chef)
                                                        <option value="{{ $chef->id }}" {{ ($foods->user_id == $chef->id) ? 'selected' : '' }}>{{ $chef->name }}</option>
                                                        @endforeach
